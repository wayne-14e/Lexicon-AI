...
## 🏛️ Technology Stack
- **AI Models**: 
  - `gemini-3-flash-preview`: For rapid vocabulary assembly and linguistic synthesis.
...
To deploy this project (e.g., to Vercel), ensure you set the `GEMINI_API_KEY` environment variable in your dashboard.
